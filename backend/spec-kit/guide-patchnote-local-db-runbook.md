...
```powershell
mysql --default-character-set=utf8mb4 -u tftuser -p tftgogo -e "source ./backend/spec-kit/sql/guide-patchnote-local-schema.sql"
mysql --default-character-set=utf8mb4 -u tftuser -p tftgogo -e "source ./backend/spec-kit/sql/guide-patchnote-local-seed.sql"
```
...
```powershell
mysql --default-character-set=utf8mb4 -u tftuser -p tftgogo -e "source ./backend/spec-kit/sql/guide-patchnote-local-reset.sql"
```
