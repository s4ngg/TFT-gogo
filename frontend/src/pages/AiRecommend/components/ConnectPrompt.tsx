import { Bot, ChevronRight, Link2, LogIn, Sparkles, TrendingUp, Trophy } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import styles from '../AiRecommend.module.css'

interface ConnectPromptProps {
  variant: 'login' | 'summoner'
}

function ConnectPrompt({ variant }: ConnectPromptProps) {
    ...
    return (
      <div className={styles.promptWrap}>
        <div className={styles.promptCard}>
          ...
          <h2>로그인 후<br />개인 맞춤 AI 추천을 받을 수 있어요</h2>
          <p>
            로그인하고 내 전적을 연동하면 최근 20게임을 분석해
            나에게 맞는 덱을 AI가 추천해 드립니다.
          </p>
